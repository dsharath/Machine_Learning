...
###############################################################
### YOUR CODE HERE
#features_train,features_test,labels_train,labels_test = cross_validation.trian_test_split(iris.data,iris.target,test_size=0.4, random_state=0)
#features_trian.shape,labels_train.shape
